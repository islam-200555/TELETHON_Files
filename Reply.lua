...
if text == 'منو المطور' or text == 'منو مطور' or text == 'اريد مطور' or text == 'منو منصبلك' then
TextReply = '[--𝘛𝘜!𝘖𝘍𝘌--](t.me/yk_yy) حبيبي هذا مطور السورس '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'اريد بوت' or text == 'اريد البوت' or text == 'حلو البوت' or text == 'عجبني البوت' or text == 'انصبلك' or text == 'انصبلك بوت' or text == 'بوت تمبلر' then
TextReply = '[--𝘛𝘜!𝘖𝘍𝘌--](t.me/yk_yy) اهلا عزيزي  متوفر تنصيب بوتات ع سورس سناب احدث واسرع البوتات وضمان الثقه للاستفسار راسل المطور '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end 
if text == 'عجبني السورس' or text == 'عجبني سورس' then
TextReply = '[--S𝗡𝗔𝗣 T𝗘𝗔𝗠--](t.me/iinzzz) اهلا عزيزي  متوفر تنصيب بوتات ع سورس سناب احدث واسرع البوتات وضمان الثقه للاستفسار قناه السورس '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end    
if text == 'هلو' then

...
if text == 'مطور السورس' or text == 'مطور تليثون' then
TextReply = '⌔︙ [𝗄𝗅𝖺𝗇𝗋 𝖺𝗅𝗈𝗈𝗌𝗁ま](t.me/klanr)'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'منو المطور' or text == 'منو تليثون'  then
TextReply = '⌔︙ [𝗄𝗅𝖺𝗇𝗋 𝖺𝗅𝗈𝗈𝗌𝗁ま](t.me/klanr) : حبيبي هذا مطور السورس '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'انصبلك'  or text == 'انصبلك بوت' or text == 'ممكن تنصيب' then
TextReply = '⌔︙ [𝗄𝗅𝖺𝗇𝗋 𝖺𝗅𝗈𝗈𝗌𝗁ま](t.me/klanr) : اهلا عزيزي متوفر تنصيب بوتات ع سورس سناب احدث واسرع البوتات وضمان الثقه للاستفسار راسل المطور'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'عجبني البوت' or text == 'اريد بوت' or text == 'تنصب' or text == 'تنصيب' then
TextReply = '⌔︙ [𝗄𝗅𝖺𝗇𝗋 𝖺𝗅𝗈𝗈𝗌𝗁ま](t.me/klanr) : اهلا عزيزي متوفر تنصيب بوتات ع سورس سناب احدث واسرع البوتات وضمان الثقه للاستفسار راسل المطور'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
...
if text == 'خوش سورس' or text == 'سورس تليثون' then
TextReply = '⌔︙ [- TeLeThOn TeaM.](t.me/L3LL3) : حبيبي هذا قناه السورس '
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end    
if text == 'هلو' then
